...
const BackupV1FieldSchema = z.strictObject({
  ...
  decreaseSpeedStep: z.number().optional(),
  increaseSpeedStep: z.number().optional(),
  ...
  overlayScale: BackupV1NonNegativeIntegerSchema.optional(),
  buttonFlash: z.boolean().optional(),
