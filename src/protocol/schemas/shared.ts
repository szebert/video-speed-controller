...
export const EditableResolvedBehaviorSchema = z.object({
  ...
  decreaseSpeedStep: resolvedSettingSchema(z.number()),
  increaseSpeedStep: resolvedSettingSchema(z.number()),
  skipBackSeconds: resolvedSettingSchema(z.number()),
  skipForwardSeconds: resolvedSettingSchema(z.number()),
  skipScaleWithPlaybackRate: resolvedSettingSchema(z.boolean()),
  rewindSpeed: resolvedSettingSchema(z.number()),
  fastForwardSpeed: resolvedSettingSchema(z.number()),
  ...
  overlayScale: resolvedSettingSchema(z.number()),
  buttonFlash: resolvedSettingSchema(z.boolean()),
...
export const ResolvedHotkeyMapSchema = z.object({
  ...
  playPause: ResolvedHotkeyBindingSchema,
